...
vi.mock('../src/hooks/useDiscoveryCatalogue', () => ({ useDiscoveryCatalogue: (...args: unknown[]) => mocks.catalogue(...args), useRankedDiscovery: () => ({ data: null, loading: false, error: null, canLoad: false, loadMore: () => {} }) }))
vi.mock('../src/hooks/usePublicHubRecentMoments', () => ({ usePublicHubRecentMoments: () => ({ loading: false, data: null }) }))
vi.mock('../src/hooks/usePublicHubData', () => ({ usePublicHubData: () => ({ loading: false, data: null }) }))
