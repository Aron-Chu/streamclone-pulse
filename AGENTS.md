...
| **StreamPulse backend (Go BFF)** | [`../streampulse-backend/AGENTS.md`](../streampulse-backend/AGENTS.md) |
| **Pulse-owned packages** | `packages/{pulse-core,pulse-charts,analytics-console}` |
