...
describe('pulseSelectPosition', () => {
  ...
  it('closes when the trigger is fully above the scrollport clip', () => {
    expect(
      isTriggerVisibleInScrollport(
  ...
  it('closes when the trigger is fully below the scrollport clip', () => {
    expect(
      isTriggerVisibleInScrollport(
  ...
  it('uses the viewport alone when no scrollport is present', () => {
    expect(
      isTriggerVisibleInScrollport(
