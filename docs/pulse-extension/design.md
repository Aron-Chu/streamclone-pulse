...
streamclone-pulse (this repo — owns public client packages)
  packages/pulse-core/         # @streampulse/pulse-core
  packages/pulse-charts/       # @streampulse/pulse-charts
  packages/analytics-console/  # @streampulse/analytics-console
  package.json / streampulse-web/package.json  # workspace consumers
  src/...                      # extension
  streampulse-web/             # portal

streampulse-backend (private — BFF owner; packages dropped)
