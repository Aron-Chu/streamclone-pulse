  ...
  return (
    <PublicLayout>
      <article className="panel public-document" data-testid="privacy-policy">
        ...
        <p className="muted">
          Last updated: July 25, 2026 · Applies to streampulse.stream and the StreamPulse Chrome
          extension.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            enabled; a versioned diagnostics-consent record when you opt in via Options (default off); and
            a separate versioned analytics-consent record when you opt in to anonymous product usage
            (default off).
          </li>
          <li>
